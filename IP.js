...
var title =flags.get(obj['countryCode']) + ' '+ REG_ValidCheck(obj['regionName']);
var subtitle =''+obj['country']+'-'+'('+ ORG_ValidCheck(obj['isp'])+')'+'';
var ip = obj['query'];
var description = 'Server:'+obj['isp'] + '\n'+'Region:' + REG_ValidCheck(obj['regionName']) + ' ' + obj['city'] + '\n' + 'IP:'+ obj['query'] + '\n' +'as:'+ obj['as'];
